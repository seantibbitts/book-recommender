...
from functions.helper_functions import predict_for_user_implicit_lightfm, predict_for_user_explicit_lightfm, get_ndcg_explicit_lightfm, ndcg_at_k
...
def explicit_recs():
    ...
    if request.method == 'POST':
        ...
        weights_array = json.loads(str(request.json))
